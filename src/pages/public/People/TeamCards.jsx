...
const JoinCard = ({ setShowModal }) => (
  <div className="w-[380px] md:w-[840px] gap-[20px] p-4 rounded-xl shadow-[2px_2px_4px_0px_#00000040,inset_2px_2px_6px_0px_#FFFFFF80] text-white flex flex-col justify-center items-center text-center">
...
const TeamMembers = () => {
  ...
  return (
    <div className="w-full opacity-100 relative top-[40px] pt-16 pb-40 md:pr-30 md:pl-30">
