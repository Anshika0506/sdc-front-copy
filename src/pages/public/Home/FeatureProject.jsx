...
const projects = [
  ...
  },
  {
    ...
    description: "It is a web based application developed for Medicaps University.",
      ...
      <div className="flex -space-x-16 md:-space-x-20 items-center overflow-x-visible">
        {[getCardAt(-1), getCardAt(0), getCardAt(1)].map((project, index) => {
          ...
          return (
            <div
              key={project.title}
              className={`w-[85%] sm:w-[70%] md:w-[450px] h-[365px] md:h-[500px] rounded-2xl transition-all duration-500 shadow-[inset_0_0_14px_rgba(255,255,255,0.3),inset_-1px_-3px_2px_rgba(255,255,255,0.1),inset_1px_3px_2px_rgba(255,255,255,0.3)] ${scale}`}
            >
              <div className="p-4 flex flex-col justify-between h-full">
                ...
                />
                <div>
                  <h3 className="text-sm md:text-xl font-semibold mb-2">{project.title}</h3>
                  <p className="text-sm text-gray-300 mb-4">{project.description}</p>
                  <span className="inline-block shadow-[inset_0_0_14px_rgba(255,255,255,0.3),inset_-1px_-3px_2px_rgba(255,255,255,0.1),inset_1px_3px_2px_rgba(255,255,255,0.3)] text-yellow-300 text-[15px] px-4 py-1 rounded-full font-mono">
                    {project.status}
                  </span>
                </div>
              </div>
