...
const HeroSection = () => {
  return (
    <section className="relative w-full overflow-hidden bg-gradient-to-br text-white">
      ...
      <div className="relative mt-25 w-full h-[30vh] sm:h-[85vh] md:h-[75vh] rounded-3xl bg-white/5 backdrop-blur-md border border-white/10 shadow-[2px_2px_6px_#00000040,inset_2px_2px_6px_#FFFFFF20] overflow-hidden flex flex-col justify-center items-center px-4 sm:px-6">
        {/* Top-left & right glowing shapes */}
        <img
          src={left}
          alt="left"
          className="absolute top-0 left-0 w-[30vw] sm:w-[40vw] max-w-[80px] sm:max-w-[160px] md:max-w-[250px] object-contain z-10"
        />
        <img
          src={right}
          alt="right"
