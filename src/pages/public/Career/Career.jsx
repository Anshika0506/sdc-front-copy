    ...
    <div>
      <div className=" text-white px-6 sm:px-20 py-24 font-sans">
        ...
        <div className="text-center mt-16">
          ...
          {showModal && (
            <div className="fixed inset-0 bg-black/50 flex justify-center items-center z-5 0">
              <div
                style={{
                  boxShadow:
                ...
                <form className="space-y-4">
                  <div className="text-left">
                    <div className="mt-[2rem]">
                      ...
                      <input
                        ...
                        className="w-full pl-[1rem] bg-transparent border border-white/30 rounded-xl px-3 py-2 text-[#A5D7E8]/50"
                      ...
                      <div>
                        ...
                        <input
                          ...
                          onInput={(e) => {
                            ...
                            // If the user types '@' and the domain isn't gmail.com, block it
                            if (
                              val.includes("@") &&
                          ...
                          <div className="relative mt-1">
                            ...
                            >
                              {selectedBranch ? (
                                ...
                                <span className="w-[410px] h-[40px] pl-[1rem] bg-transparent  border-white/30 rounded-xl px-3 py-2 text-[#A5D7E8]/50">
                                  Select your Branch
                                </span>
                              )}
                            </Listbox.Button>
                    ...
                    <div className="flex mt-[0.5rem] gap-5">
                      <div>
                        ...
                        <input
                          ...
                          className="w-[410px] h-[40px] pl-[1rem] bg-transparent border border-white/30 rounded-xl px-3 py-2 text-[#A5D7E8]/50"
                          ...
                          <div className="relative mt-1 w-[420px]">
                            ...
                            >
                              {selectedPosition ? (
                                ...
                                <span className="w-[410px] h-[40px] pl-[1rem] bg-transparent  border-white/30 rounded-xl  text-[#A5D7E8]/50">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      rows={3}
                      className="w-full pl-[1rem]  border  border-white/30 rounded-xl px-3 py-2 text-[#A5D7E8]/50"
                  ...
                  <div className="flex flex-col sm:flex-row items-center justify-between mt-6">
                    <label className="flex items-center gap-2 cursor-pointer">
                      ...
                      <span
                        ...
                        className=" bg-[#2B88A8] text-white text-sm px-4 py-2 rounded-md pt-[0.5rem]"
                      >
                        + ATTACH RESUME
                      </span>
                      {resumeFile && (
