  ...
  return (
    <div className="w-full h-full text-white p-4 sm:p-6 flex flex-col">
      ...
      <div className="w-full h-[73px] flex justify-end gap-5 px-7 bg-[#30303099]/60" style={{ fontSize: 16, fontWeight: 600 }}>
          ...
          <div className="fixed inset-0 z-50 bg-black/40 flex items-center justify-center">
            <div className="bg-[#1a1a1a] w-[900px] max-h-[70vh] rounded-xl shadow-lg border border-[#5a5a5a] flex flex-col cursor-default">
              ...
              <div className="h-[60px] w-full flex justify-between items-center px-7 bg-[#8E8E8E] rounded-t-xl">
                ...
                <div className="h-[32px] w-[32px] rounded-sm p-1.5 bg-[#333333] cursor-pointer flex items-center justify-center" onClick={() => setIsEditing(false)}>
                ...
                {editFaqs.map((item, idx) => (
                  <div key={item.id || `new-${idx}`} className="flex mb-5">
                    ...
                    <div className="flex flex-col justify-center">
                      <button onClick={() => handleDelete(item.id)} className="w-[40px] h-[40px] rounded-xl bg-[#ACACAC40]/60 flex items-center justify-center mb-20">
              ...
              {/* Footer */}
              <div className="h-[73px] flex justify-end gap-3 px-6 py-1 bg-[#30303099]/30 rounded-b-xl border-t border-[#5a5a5a]">
                <button onClick={handleSave} className="w-[105px] h-[45px] rounded-xl border-[2px] bg-[#ACACAC40]/60 border-[#FFFFFF] flex items-center justify-center gap-2 text-white px-4">
                  <img src={RightIcon} alt="save" className="h-[25px] w-[25px]" />
                  <p>SAVE</p>
                </button>
                <button onClick={handleAddNew} className="w-[135px] h-[45px] rounded-xl border-[2px] bg-[#ACACAC40]/60 border-[#FFFFFF] flex items-center justify-center gap-2 text-white px-4">
        ...
        <button onClick={handleEdit} className="w-[105px] h-[45px] mt-3 rounded-xl border-[2px] bg-[#ACACAC40]/60 border-[#FFFFFF] flex items-center justify-center gap-2 text-white px-4">
          <img src={EditIcon} alt="edit" className="h-[25px] w-[25px]" />
          <p>EDIT</p>
        </button>
        <button onClick={handleDeleteAll} className="w-[125px] h-[45px] mt-3 rounded-xl border-[2px] bg-[#ACACAC40]/60 border-[#FFFFFF] flex items-center justify-center gap-2 text-white px-3">
