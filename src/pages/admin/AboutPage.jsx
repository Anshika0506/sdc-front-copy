...
const Main = () => {
  ...
  return (
    <div className='w-[1136px] h-[856px] pb-[159px] pt-10 pl-7'>
      <div className='w-[1136px] h-[60px] flex justify-between px-7 py-2 bg-[#8E8E8E] rounded-t-xl'>
        <h1 className="font-semibold text-[#333] py-1.5" style={{ fontFamily: "Inter", fontSize: 22, fontWeight: 600 }}>SDC Overview</h1>
        <div className='flex gap-4'>
          <p className='py-2.5 font-mono text-[#333]' style={{ fontWeight: 400, fontSize: 16 }}>Page</p>
          <button
      ...
      <div className="bg-[#1a1a1a] w-[1136px] h-[370px] text-white font-sans rounded-b"
        style={{
  ...
  <img src={frame4Img} alt="" className='w-[252px] h-[124px] ' />
        ...
        <div className='w-[1136px] h-[73px] mt-4 flex justify-between px-7 bg-[#30303099]/60' style={{ fontSize: 16, fontWeight: 600 }}>
          <div>
  ...
  <label className="relative w-[200px] h-[124px] flex items-center justify-center cursor-pointer">
    <img src={frame1Img} alt="" className='w-[200px] h-[124px] rounded opacity-20' />
  ...
  <label className="relative w-[200px] h-[124px] flex items-center justify-center cursor-pointer">
    <img src={frame2Img} alt="" className='w-[200px] h-[124px] rounded opacity-20' />
    <span className="pointer-events-none absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex items-center justify-center opacity-100">
      <img src={pencil} alt="edit" className='w-[40px] h-[40px]'/>
    </span>
    <input
  ...
  <label className="relative w-[200px] h-[124px] flex items-center justify-center cursor-pointer">
    <img src={frame3Img} alt="" className='w-[200px] h-[124px] rounded opacity-20' />
    <span className="pointer-events-none absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex items-center justify-center opacity-100">
      <img src={pencil} alt="edit" className='w-[40px] h-[40px]'/>
    </span>
    <input
  ...
  <label className="relative w-[200px] h-[124px] flex items-center justify-center cursor-pointer">
    <img src={frame4Img} alt="" className='w-[200px] h-[124px] rounded opacity-20' />
    <span className="pointer-events-none absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex items-center justify-center opacity-100">
      <img src={pencil} alt="edit" className='w-[40px] h-[40px]'/>
    </span>
    <input
